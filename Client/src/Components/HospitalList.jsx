...
function HospitalList(){
  ...
  function onDeleteClick(id){
    ...
    (window.confirm("Do you want to delete it?")===true)?(navigate("/hospitaldelete/"+id)):(navigate("/hospitallist"))
 ...
 <div>
    ...
    <h3 style={{textAlign:"center"}} class="text-primary p-4">Hospitals Available</h3>
    ...
    <table className="table table-striped" style={{color:"black"}}>
      ...
      <tr>
        ...
        <td><a href={"/hospitaldata/"+x._id}><i class="fa-solid fa-circle-info"></i></a></td>
        <td><a href={"/hospitaledit/"+x._id}><i class="fa-solid fa-pen-to-square"></i></a></td>
        <td><button 
        ...
        {/* <td><a href={"/hospitaldelete/"+x._id}><i class="fa-solid fa-trash"></i></a></td> */}
      </tr> )}    
      </tbody>
    </table>
    </div>
