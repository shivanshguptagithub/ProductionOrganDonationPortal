...
function DonorEdit(props){
  ...
  const PostData=async (event)=>{
    ...
    const res= await fetch("http://localhost:5000/donorEdit/"+id,{
      method:"POST",
      headers:{
    ...
    >
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
          ...
          <a href="/DonorList" class="nav-item nav-link">
            Donor List
          </a>
    ...
    {/*form start*/}
        <div class="container-xxl py-3" id="contact">
            ...
            <div class="row g-5" >
                ...
                >
               <h3 class="text-primary p-4">Edit Donor Information</h3>
                {/* Pills navs*/}
                <div className="bg-light rounded h-100 d-flex align-items-center p-5 py-1">
                    ...
                    <div class="row g-3">
                        ...
                        <label class="col-sm-2 col-3 ps-3 py-3 px-2">Age * :</label>
                        <div class="col-sm-10 col-9">
                        <input
                            type="number"
                            id="age"
                        ...
                        <label class="col-sm-2 col-3 ps-3 py-3 px-2">Blood Group * :</label>
                        <div class="col-sm-10 col-9">
                        <select 
                            onChange={handleChange}
                            class="form-control border-0" 
                        ...
                        <label class="col-sm-2 col-3 ps-3 py-3 px-2">Organ * :</label>
                        <div class="col-sm-10 col-9">
                        <input
                            type="text"
                            id="organ"
